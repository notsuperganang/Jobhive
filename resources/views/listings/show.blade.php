<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <container class="px-5 py-24 mx-auto">
            <div class="mb-12">
            ...
            <div class="-my-6">
                <div class="flex flex-wrap md:flex-nowrp">
                    <div class="container w-full md:w-3/4 pr-4 leading-relaxed text-base">
                        {!! $listing->content !!}
                    </div>
                    <div class="w-full md:w-1/4 pl-4">
                        <img src="/storage/{{ $listing->logo }}" alt="{{ $listing->company }} logo" class="mx-w-full mb-4">
