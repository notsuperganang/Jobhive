...
<div class="mb-4 mx-2">
    ...
    ></textarea>
        ...
        <div class="mb-2 mx-2"></div>
            ...
            value=""/>
            <button type="submit" id="form_submit" class="block w-full items-center bg-indigo-500 text-white border-0 py-2 focus::outline-none hoer:bg-indigo-600 rounded text-base mt-4 md:mt-0">pay + continue</button>
